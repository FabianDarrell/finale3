...
import 'package:finale3/apis/notification_api.dart';
import 'package:finale3/apis/storage_api.dart';
import 'package:finale3/apis/tweet_api.dart';
import 'package:finale3/core/enums/notification_enum.dart';
...
import 'package:finale3/features/notifications/controller/notification_controller.dart';
...
final getRepliesToTweetsProvider = FutureProvider.family((ref, Tweet tweet) async {
  final tweetController = ref.watch(tweetControllerProvider.notifier);
...
class TweetController extends StateNotifier<bool> {
  ...
  void likeTweet(Tweet tweet, UserModel user) async {
    ...
    res.fold((l) => null, (r) {
      _notificationController.createNotification(text: '${user.name} liked your tweet', postId: tweet.id, notificationType: NotificationType.like, uid: tweet.uid);
    });
  }
