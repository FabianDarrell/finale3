...
import 'package:finale3/constants/assets_constants.dart';
import 'package:finale3/core/enums/tweet_enum.dart';
import 'package:finale3/features/auth/controller/auth_controller.dart';
import 'package:finale3/features/tweet/controller/tweet_controller.dart';
import 'package:finale3/features/tweet/views/twitter_reply.dart';
import 'package:finale3/features/tweet/widgets/carousel_image.dart';
import 'package:finale3/features/tweet/widgets/hashtag_text.dart';
import 'package:finale3/features/tweet/widgets/tweet_icon.dart';
import 'package:finale3/features/user_profile/view/user_profile_view.dart';
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            SvgPicture.asset(AssetsConstants.retweetIcon, color: Pallete.greyColor, height: 20),
                        ...
                        ref.watch(getTweetByIdProvider(tweet.repliedTo)).when(
                          ...
                          final replyingToUser = ref.watch(
                            userDetailsProvider(repliedToTweet.uid)).value;
                        ...
                        }, error: (error, stackTrace) => ErrorText(error: error.toString()), loading: () => const SizedBox()),
                        ...
                        if(tweet.link.isNotEmpty)...[
                          ...
                          AnyLinkPreview(displayDirection: UIDirection.uiDirectionHorizontal, link: 'https://${tweet.link}')
                        ],
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              TweetIconButton(
                                ...
                                onTap: () {
                                  ref.read(tweetControllerProvider.notifier).reshareTweet(tweet, currentUser, context);
                                }),
                              LikeButton (
                                size: 25,
                                onTap: (isLiked) async {
                              ...
                              IconButton(onPressed: () {}, icon: const Icon(Icons.share_outlined, size: 25, color: Pallete.greyColor,))
                            ],
                          ),
                        ),
